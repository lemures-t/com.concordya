...
// gulp.task('default',['server','watch'],function(){
	...
	// gulp.task('watch',function(){
		gulp.watch('./src/style.less',['less','reload_less']);
		gulp.watch(['./src/*','!./src/style.less'],['reload_except_less']);
	});
	...
	gulp.task('rl_html',['rl_css','rl_js','rl_lib','rl_pic','clean:dist','copy:html','clean:html'],function(){
		...
		return	es.concat(
					gulp.src('./dist/index.html')
						...
						.pipe(plugins.inject(index_other_src,{relative:true,name:'release'}))
						.pipe(gulp.dest('./dist')),
